...
public class TopSecretLink1 {
	WebDriver driver;
	public TopSecretLink1(WebDriver driver) {
		this.driver=driver;
...
//@FindBy(xpath = "//div[@class='relative text-[#FFD014] !w-20 flex items-center px-5 justify-center p-3 border-none rounded-xl bg-yellowLight animate-wiggle']") private WebElement video1;
...
//enter sendkeys use this drive link
//  https://docs.google.com/spreadsheets/d/1oz-tz5NsOay1tMZiXoioFCloHjjCj9VA/edit?usp=sharing&ouid=113053394257558002119&rtpof=true&sd=true
...
//@FindBy(xpath = "//div[@class='flex gap-2 items-center']")
//private WebElement share;
...
public void secretLinkCreate() throws HeadlessException, UnsupportedFlavorException, IOException {
...
//	 WebElement desc = driver.findElement(By.xpath("//p[@class='text-sm font-semibold']"));
//	 js.executeScript("arguments[0].scrollIntoView();", desc);
//	 btndescription.click();
//	description.sendKeys("In this file have test cases of OpeninApp application");
//	savedesc.click();
	
	//JavascriptExecutor js1=(JavascriptExecutor)driver;
//	 WebElement scrollUp = driver.findElement(By.xpath("//div[@class='z-10 flex flex-col items-center border-1']"));
//	 js1.executeScript("arguments[0].scrollIntoView();", scrollUp);
	
//	 WebElement scrollUp = driver.findElement(By.xpath("//img[@alt='shield']"));
