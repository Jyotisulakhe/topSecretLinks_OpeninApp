...
public class TopSecretLink4 {
	WebDriver driver;
	public TopSecretLink4(WebDriver driver) {
		this.driver=driver;
	...
	public WebElement getTopsecLinks() {
		...
		public void secretLinkCreate4() throws HeadlessException, UnsupportedFlavorException, IOException {
			topsecLinks.click();
			startBtn.click();
			priceSet.click();
//			video1.click();
