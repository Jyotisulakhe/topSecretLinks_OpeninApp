...
public class TopSecretLink2 {
	WebDriver driver;
	public TopSecretLink2(WebDriver driver) {
		this.driver=driver;
	...
	public void secretLinkCreate2() throws HeadlessException, UnsupportedFlavorException, IOException {
		topsecLinks.click();
		startBtn.click();
		priceSet.click();
//		video1.click();
	...
	String copiedLink2 = (String) Toolkit.getDefaultToolkit().getSystemClipboard().getData(DataFlavor.stringFlavor);

	
	System.out.println(copiedLink2);
	}
